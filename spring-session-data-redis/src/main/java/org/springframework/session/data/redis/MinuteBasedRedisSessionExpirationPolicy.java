 ...
 * @since 1.0
 */
public final class MinuteBasedRedisSessionExpirationPolicy implements RedisSessionExpirationPolicy {

	private static final Log logger = LogFactory.getLog(MinuteBasedRedisSessionExpirationPolicy.class);
	...
	public MinuteBasedRedisSessionExpirationPolicy(RedisOperations<String, Object> sessionRedisOperations,
